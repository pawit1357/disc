...
<body
	...
	<div class="page-header navbar navbar-fixed-top">
		...
		<div class="page-header-inner ">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<a href="#">  <img src="<?php echo ConfigUtil::getAppName();?>/images/logo_main.png" alt="logo" class="logo-default" style="position: absolute;top: -28px;left:-10px; !important" height="60" /> 
