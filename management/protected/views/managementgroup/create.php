						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text"
									value="<?php echo ManagementGroup::getMax();?>"
						...
						<div class="form-group">
							...
							<div class="radio-list">
								<label class="radio-inline"> <input type="radio" id="is_active"
									name="ManagementGroup[is_active]" value="A" checked="checked"/> Active
								</label> <label class="radio-inline"> <input type="radio"
									id="transaction_type" name="ManagementGroup[is_active]" value="I"/> InActive
								</label>
