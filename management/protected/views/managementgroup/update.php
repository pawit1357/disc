<form id="Form1" method="post" enctype="multipart/form-data"
	...
	<div class="portlet light">
		<div class="portlet-title">
			...
			<div class="actions">
			<?php echo CHtml::link('ย้อนกลับ',array('ManagementGroup/'),array('class'=>'btn btn-default btn-sm'));?>
			</div>
		</div>
		<div class="portlet-body form">
			<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="id" type="text"
									...
									class="grpOfInt form-control" name="ManagementGroup[id]" readonly>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="name" type="text" value="<?php echo $data->name;?>"
									class="form-control" name="ManagementGroup[name]">
							</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-md-3">รายละเอียด:<span class="required">*</span></label>
							<div class="col-md-6">
								<input id="description" type="text" value="<?php echo $data->description;?>"
									class="form-control" name="ManagementGroup[description]">
							</div>
							<div id="divReq-name"></div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="radio-list">
								<label class="radio-inline"> <input type="radio" id="is_active"
									name="ManagementGroup[is_active]" value="A" <?php echo $data->is_active =='A'? "checked=checked":''; ?>/> Active
								</label> <label class="radio-inline"> <input type="radio"
									id="is_active" name="ManagementGroup[is_active]" value="I" <?php echo $data->is_active =='I'? "checked=checked":''; ?>/> InActive
								</label>
					...
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<?php echo CHtml::link(ConfigUtil::getBtnCancelButton(),array('ManagementGroup/'),array('class'=>'btn btn-default uppercase'));?>
							</div>
						</div>
					</div>
