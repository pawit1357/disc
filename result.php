...
if (isset($_POST['m']) && isset($_POST['l'])) {
    ...
    if (isset($time_value)) {
        ...
        $sqlInsert = "INSERT INTO questionnaire(request_ip,person_name,person_sex,person_age,person_phone_num,person_email,create_date,start_date,end_date) VALUES('" . $_SERVER['REMOTE_ADDR'] . "','" . $_POST['person_name'] . "','" . $_POST['person_sex'] . "','" . $_POST['person_age'] . "','" . $_POST['person_phone_num'] . "','" . $_POST['person_email'] . "',NOW(),'" . $startDate . "','" . $endDate . "');";
